...
Route::group(['prefix' => 'guest'], function () {
    ...
    Route::get('search', 'GuestController@get_search_results');
});
...
Route::group(['prefix' => 'auth', 'middleware' => ['auth:api']], function () {
    ...
    Route::put('update_name', 'AuthController@update_auth_name');
    Route::put('update_password', 'AuthController@update_auth_password');
