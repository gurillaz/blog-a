    ...
    <v-content>
        <v-container class="fill-height" fluid>
            <v-row align="center" justify="center">
                <v-col cols="5">
                                      <v-card outlined class="mb-6" v-if="success">
                        <v-card-text >
                            <span
                                class="text-uppercase font-weight-bold"
                            >Verification mail sent. </span>
                            <router-link
                    ...
                    <v-card class="elevation-12" v-else>
                        ...
                        <v-card-actions class="pa-5">
                            ...
                            <v-btn :color="has_error?'red':'indigo'" @click="requestResetPassword" block dark>Send Password Reset Link</v-btn>
                        </v-card-actions>
                    </v-card>
                </v-col>
            </v-row>
